    ...
    public class UserDataHandler : User, IUserDataHandler
    {
        ...
        private bool saveUser(string command) {
            ...
            try
            {
                ...
                mySqlCommand.Parameters.Add(new MySqlParameter("_dob", this.dob));
                mySqlCommand.Parameters.Add(new MySqlParameter("_user_type", this.userType));
                ...
                mySqlCommand.Parameters.Add(new MySqlParameter("_gender", this.gender));
